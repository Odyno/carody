...
function register_carody_eqp_index_page() {
  add_menu_page('ParcoMezzi', 'Parco dei mezzi', 'carody_read', 'carody/eqp/eqp-index.php', '', plugins_url('/carody/images/Fuel_Icon.png'), 6);
...
function register_carody_fuel_index_page() {
  add_menu_page('DiarioRifornimenti', 'Diario rifornimenti', 'carody_read', 'carody/fuel/fuel-index.php', '', plugins_url('/carody/images/Fuel_Icon.png'), 7);
...
function register_carody_events_index_page() {
  add_menu_page('DiarioManutenzione', 'Diario manutenzione', 'carody_read', 'carody/events/event-index.php', '', plugins_url('/carody/images/Fuel_Icon.png'), 8);
  add_submenu_page('carody/events/event-index.php', 'AlmanaccoInterventi', 'Lista interventi', 'carody_read', 'carody/events/event-index.php', '');
  add_submenu_page('carody/events/event-index.php', 'NuovoIntervento', 'Nuovo', 'carody_read', 'carody/events/event-mgt.php', '');
  add_submenu_page('carody/events/event-index.php', 'PrevisioniIntervento', 'Previsioni', 'carody_read', 'carody/todo-index.php', '');
}
