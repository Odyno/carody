...
function register_carody_profile_page() {
	add_users_page('Modifica Auto', 'Modifica Auto', 'read', 'carody/eqp/eqp-user-mgt.php', '');
}

function register_carody_fuel_index_page() {
  add_menu_page('DiarioRifornimenti', 'Diario rifornimenti', 'carody_read_report_fuel', 'carody/fuel/fuel-index.php', '', plugins_url('/carody/images/Fuel_Icon.png'));
...
function register_carody_eqp_index_page() {
  add_menu_page('ParcoMezzi', 'Parco dei mezzi', 'carody_read_eqp', 'carody/eqp/eqp-index.php', '', plugins_url('/carody/images/Fuel_Icon.png'));
...
function register_carody_events_index_page() {
  add_menu_page('DiarioManutenzione', 'Diario manutenzione', 'carody_read_event', 'carody/events/event-index.php', '', plugins_url('/carody/images/Fuel_Icon.png'));
